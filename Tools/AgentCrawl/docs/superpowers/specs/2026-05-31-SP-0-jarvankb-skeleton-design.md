...
原 `Tools/AgentCrawl/` 仓库定位为"Zhihu + Bilibili 爬虫工具集合"，bootstrap 期已完成 HarnessStack v1 recipe `openspec-superpowers-repomem-sendbox-dashboard` 的脚手架（14 份 RepoMem 文档、CLAUDE.md 13 步 pipeline、OpenSpec 软链工作区、cc-dashboard 看板、sendbox 通道）。
