...
- 用 `using-git-worktrees` skill 起 worktree（在 `Tools/AgentCrawl/.worktrees/sp1-cookie-manager/` 或类似）
...
**Parent's cwd**: `/home/shenzhou/Codes/awesome_agent_tools/Tools/AgentCrawl/`（你和 orche 同 cwd；用相对路径即可）
